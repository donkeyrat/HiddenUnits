...
namespace HiddenUnits 
{
    public class BillyLaser : MonoBehaviour 
    {
        ...
        public void DoDamage(Collider col)
        {
            ...
            WilhelmPhysicsFunctions.AddAxplosionForceWithMinWeight(col.attachedRigidbody, knockback * num2, transform.position, 3f, ForceMode.Impulse, massCap);
            col.attachedRigidbody.velocity *= 0.9f;
            WilhelmPhysicsFunctions.AddAxplosionForceWithMinWeight(enemyUnit.data.mainRig, knockback * num2, transform.position, 3f, ForceMode.Impulse, massCap);
